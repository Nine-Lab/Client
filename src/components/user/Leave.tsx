    ...
    {isOpenModal && (
      ...
      <S.page>
        <S.contentWrap>
          ...
          <S.bottomButton onClick={onClickToggleModal}>탈퇴하기</S.bottomButton>
      </S.page>
    </form>
    </Modal>
    )}
    <DialogButton onClick={onClickToggleModal}><img src="../../Leave_logo.png" alt="asd" width={400} height={300} /></DialogButton>
    </ErrorBoundary>
  );
}
