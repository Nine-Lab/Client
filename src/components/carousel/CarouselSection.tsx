                        ...
                        >
                            <Typography variant="h5" gutterBottom>
                                ...
                                >
                                    ...
                                    입자로 입자 크기에 따라 직경 10㎍이하 인것을
                                    미세먼지(PM10)라고 합니다. 미세먼지는 보통
                                    실외 공기질에만 영향을 끼친다고 생각을
                                    할텐데요. 이러한 미세먼지가 실내 공기에도
                                    영향을 끼친다는 사실, 알고 계셨나요?
                                </Typography>
                                <Typography variant="h5" gutterBottom>
                                    <br />
                                    ...
                                    <Typography
                                        ...
                                        gutterBottom
                                    >
                                        홍수는 우리나라에서 중대한 자연재해이며,
                                        도시의 침수는 주거환경에 큰 영향을
                                        미치고 있습니다. 홍수의 위험성에 대한
                                        인식을 높이기 위해 홍수 조절 인프라 구축
                                        등 주거환경에 미치는 홍수의 영향을
                                        완화하기 위한 다양한 조치가 시행되고
                                        있습니다. 이러한 노력에도 불구하고,
                                        홍수는 우리나라의 중요한 과제로 남아
                                        있습니다.
                                    </Typography>
                                </Typography>
                            </Typography>
