      ...
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={2}>
          ...
          >
            ...
            <SubInfoCotainer sx={{ width: "40%", paddingTop: "6.5rem" }}>
              <Typography variant="h6" gutterBottom>
                미세먼지 정보 &nbsp;&nbsp;
                <Typography variant="caption" display="block" gutterBottom>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Cupiditate nobis dolores ullam, temporibus maxime possimus
                  inventore atque fuga quas ea aliquid, ex iure? Sequi
                </Typography>
              </Typography>
              <Typography variant="h6" gutterBottom>
                침수관련 정보
